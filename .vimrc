...
vmap tb <esc>:TagbarToggle<cr><c-l>
imap tb <esc>:TagbarToggle<cr><c-l>
map <F6> :TagbarToggle<cr><c-l>
vmap <F6> <esc>:TagbarToggle<cr><c-l>
imap <F6> <esc>:TagbarToggle<cr><c-l>
let g:tagbar_sort = 0
